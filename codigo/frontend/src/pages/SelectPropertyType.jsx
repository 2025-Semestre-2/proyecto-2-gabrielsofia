...
export default function SelectPropertyType({
  ...
  const [selectedProperty, setSelectedProperty] = useState(
    hospedajeData.tipoHospedaje || ""
  );
  const [stayType, setStayType] = useState(
    hospedajeData.stayType || ""
  );
              ...
              {propertyOptions.map((option) => {
                ...
                return (
                  <button
                    ...
                    `}
                  >
                    <div className={`text-4xl transition-colors ${isSelected ? "text-[#99BFA1]" : "text-gray-400"}`}>
                      {option.icon}
                    </div>
                    <span className="text-lg font-normal text-center">{option.label}</span>
                  </button>
                );
              })}
            </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-700 text-lg mb-2 font-medium">{option.description}</p>
